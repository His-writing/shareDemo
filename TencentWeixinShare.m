...
//    [WXApi sendReq:req];
    ...
    WXMediaMessage *messageq=[WXMediaMessage message];
    
    messageq.title = wxtitle;
    
    
    messageq.description = message;
    
    
    
    [messageq setThumbImage:[UIImage imageWithData:imageData]];
    
    WXWebpageObject *ext = [WXWebpageObject object];
    ext.webpageUrl = webpageUrl;
    
    messageq.mediaObject = ext;
    messageq.mediaTagName = @"WECHAT_TAG_JUMP_SHOWRANK";
    
    SendMessageToWXReq* req = [[SendMessageToWXReq alloc] init];
    req.bText = NO;
    req.message = messageq;
    req.scene = _scene;
    [WXApi sendReq:req];
